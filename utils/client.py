...
class HTTPClient(object):
    ...
    def send(self,params=None, data=None, **args):
        response = self.session.request(method=self.method,url=self.url, params=params,data=data,**args)
